...
export default function Reachout({
  ...
  return (
    <div className="pb-6 sm:pb-8 pl-4 flex flex-col items-center justify-center">
      <div className="text-center w-full items-center justify-center max-w-4xl mx-auto">
        <div className="mb-4 sm:mb-6 items-center justify-center">
          <h2 className="font-[family-name:var(--font-instrument-serif)] text-2xl sm:text-2xl mb-2 opacity-20 mt-4 sm:mt-6">
            {title}
          </h2>
          <p className="opacity-20 text-lg sm:text-lg mb-3 sm:mb-4">
            {subtitle}
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-3 sm:gap-4">
          {socialLinks.github && (
            ...
            >
              <FaGithub size={24} className="group-hover:scale-110 transition-transform duration-200 flex-shrink-0 text-gray-700 dark:text-gray-200 sm:text-gray-600 sm:dark:text-gray-300" />
          ...
          {socialLinks.twitter && (
            ...
            >
              <FaXTwitter size={24} className="group-hover:scale-110 transition-transform duration-200 flex-shrink-0 text-gray-700 dark:text-gray-200 sm:text-gray-600 sm:dark:text-gray-300" />
              <span className="hidden sm:inline text-sm font-medium dark:text-white/80 text-black/80 group-hover:text-[#006FEE] transition-colors duration-200">
                Twitter
              </span>
            </a>
          ...
          {socialLinks.linkedin && (
            ...
            >
              <FaLinkedin size={24} className="group-hover:scale-110 transition-transform duration-200 flex-shrink-0 text-gray-700 dark:text-gray-200 sm:text-gray-600 sm:dark:text-gray-300" />
              <span className="hidden sm:inline text-sm font-medium dark:text-white/80 text-black/80 group-hover:text-[#006FEE] transition-colors duration-200">
                LinkedIn
              </span>
            </a>
          ...
          {socialLinks.mail && (
            ...
            >
              <IoMdMail size={24} className="group-hover:scale-110 transition-transform duration-200 flex-shrink-0 text-gray-700 dark:text-gray-200 sm:text-gray-600 sm:dark:text-gray-300" />
              <span className="hidden sm:inline text-sm font-medium dark:text-white/80 text-black/80 group-hover:text-[#006FEE] transition-colors duration-200">
                Mail
              </span>
            </a>
        ...
        <div className="mt-6 sm:mt-8 pt-4 sm:pt-6">
          <div className="flex flex-col space-y-2 sm:space-y-3 lg:flex-row lg:justify-center lg:items-center lg:space-y-0 text-center">

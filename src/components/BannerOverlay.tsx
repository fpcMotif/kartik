...
export default function BannerOverlay({
  ...
  const overlayClasses = {
    ...
    bottom:
      "absolute bottom-0 left-0 right-0 h-[60px] bg-gradient-to-t dark:from-[#121212] from-[#fff] to-transparent",
    ...
    right:
      "absolute top-0 right-0 w-[20px] sm:w-[60px] h-full bg-gradient-to-l dark:from-[#121212]/20 sm:dark:from-[#121212] from-[#fff]/20 sm:from-[#fff] to-transparent",
  };
